...
def test_extract_the_domain_from_domain_with_path ():
...
def test_extract_the_domain_from_domain_with_query_and_parameters ():
...
def test_extract_the_domain_from_domain_with_different_top_level_domain ():
    input = "https://www.bbc.co.uk/sport"
    expected = 'bbc.co.uk'
    result = extract_domain_name(input)
    print(f"Result is: {result}")
    assert expected == result